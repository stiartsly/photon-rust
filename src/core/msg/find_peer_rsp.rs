...
pub(super) struct FindPeerResponseMsg {
    parts: MsgParts,
    results: Results,
}

#[allow(dead_code)]
impl FindPeerResponseMsg {
...
impl PartsProxy for FindPeerResponseMsg {
...
impl ResultProxy for FindPeerResponseMsg {
...
impl ToString for FindPeerResponseMsg {
