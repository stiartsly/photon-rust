...
pub(super) struct FindValueResponseMsg {
    parts: MsgParts,
    results: Results,
}

#[allow(dead_code)]
impl FindValueResponseMsg {
    pub(super) fn new() -> Self {
        FindValueResponseMsg {
            parts: MsgParts::new(),
            results: Results::new()
        }
    }
...
impl PartsProxy for FindValueResponseMsg {
...
impl ResultProxy for FindValueResponseMsg {
...
impl ToString for FindValueResponseMsg {
