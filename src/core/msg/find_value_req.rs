...
pub(super) struct FindValueRequestMsg {
    parts: MsgParts,
    filters: Filters
}

#[allow(dead_code)]
impl FindValueRequestMsg {
...
impl PartsProxy for FindValueRequestMsg {
...
impl FilterProxy for FindValueRequestMsg {
    fn target(&self) -> &Id {
        &self.filters.target
    }
...
impl ToString for FindValueRequestMsg {
