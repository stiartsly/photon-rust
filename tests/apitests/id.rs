...
mod apitests {
    ...
    #[test]
    fn test_distance() {
        let id1 = Id::of_hex("00000000f528d6132c15787ed16f09b08a4e7de7e2c5d3838974711032cb7076").expect("Invalid hex Id");
        let id2 = Id::of_hex("00000000f0a8d6132c15787ed16f09b08a4e7de7e2c5d3838974711032cb7076").expect("Invalid hex Id");
    ...
    fn test_equal() {
        let hex_str = "71e1b2ecdf528b623192f899d984c53f2b13508e21ccd53de5d7158672820636";
        let id1 = Id::of_hex(hex_str).expect("Invalid hex Id");
        let id2 = Id::of_hex(hex_str).expect("Invalid hex Id");
        assert_eq!(id1, id2);
    }
